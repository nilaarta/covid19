...
<div class="card-body">
    ...
    <h4><i class="icon fa fa-calendar-times-o red"></i> Data Kabupaten Yang Belum Diupdate per <strong>{{$tanggalSekarang}}</strong></h4>
        <p>
        @foreach ($kabupatenBelumUpdate as $item)
        {{$item->kabupaten}} ,
        @endforeach    
        </p>
        <p>Silahkan melakukan update data</P>
    </div>
    @else
